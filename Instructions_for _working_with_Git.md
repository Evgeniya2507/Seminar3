...
* в GitHub после внесения обновления появится кнопка pull request. Жмем на нее и информация с предложением изменений отправляется вледельцу репозитория, изменения в проект которого мы вносили.